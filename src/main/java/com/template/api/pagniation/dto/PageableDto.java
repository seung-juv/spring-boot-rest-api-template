package com.template.api.pagniation.dto;
...
public class PageableDto {
    ...
    private static class Request {
        ...
        private static PageRequest of(int page, int limit, List<String> sorts) {
            ...
            for (String sort : sorts) {
                ...
                Sort.Direction direction = Order.valueOf(splitSort[1]).dir;
    ...
    public static class Page {
        ...
        public static class Request extends PageableDto.Request {
            ...
            public static PageRequest of(int page, int limit, List<String> sorts) {
                return PageableDto.Request.of(page, limit, sorts);
            }

            private Pageable getPageable() {
                return of(this.getPage(), this.getLimit(), this.getSorts());
            }
        }
    ...
    public static class Cursor {
        ...
        public static class Request<T> extends PageableDto.Request {
            ...
            public static PageRequest of(int limit, List<String> sorts) {
                return PageableDto.Request.of(1, limit, sorts);
            }

            public Pageable getPageable() {
                return of(this.getLimit(), this.getSorts());
            }
        }
        ...
        public static class Response<T, R> extends PageableDto.Response<R> {
            ...
            public static <T, D, P> Response<T, D> of(T cursor, T nextCursor, org.springframework.data.domain.Page<P> page, List<D> data) {
